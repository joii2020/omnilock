...
build/dump_secp256k1_data: c/dump_secp256k1_data.c $(SECP256K1_SRC_20210801)
	mkdir -p build
...
build/omni_lock.o: c/omni_lock.c c/omni_lock_supply.h c/omni_lock_acp.h build/secp256k1_data_info.h $(SECP256K1_SRC_20210801) c/ckb_identity.h
	$(CC) -c $(OMNI_LOCK_CFLAGS) -o $@ $<
